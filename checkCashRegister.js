...
["QUARTER", 4.25], ["ONE", 90], ["FIVE", 55], ["TEN", 20], ["TWENTY", 60], ["ONE HUNDRED", 100]]);
console.log(`result: ${test1} - \nexpect {status: "OPEN", change: [["QUARTER", 0.5]]}`);

let test2 = checkCashRegister(3.26, 100, [["PENNY", 1.01], ["NICKEL", 2.05], ["DIME", 3.1],
["QUARTER", 4.25], ["ONE", 90], ["FIVE", 55], ["TEN", 20], ["TWENTY", 60], ["ONE HUNDRED", 100]]);
console.log(`result: ${test2} - \nexpect {status: "OPEN", change: [["TWENTY", 60], ["TEN", 20],
...
console.log(`result: ${test3} - \nexpect {status: "INSUFFICIENT_FUNDS", change: []}`);
...
["QUARTER", 0], ["ONE", 0], ["FIVE", 0], ["TEN", 0], ["TWENTY", 0], ["ONE HUNDRED", 0]])
console.log(`result: ${test5} - \nexpect {status: "CLOSED", change: [["PENNY", 0.5],
["NICKEL", 0], ["DIME", 0], ["QUARTER", 0], ["ONE", 0], ["FIVE", 0], ["TEN", 0], ["TWENTY", 0],
["ONE HUNDRED", 0]]}`);
